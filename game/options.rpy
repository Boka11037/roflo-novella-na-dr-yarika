...
define config.name = _("Yaroslav_Novell")
...
define gui.about = _p("""
поздравляю с днём рождения{p}
соси хуй без сожаления{p}
желаю счастья, здоровья, удачи{p}
в дотку гамать не сможешь иначе{p}
ебчуие стихи писать не умею{p}
нахуй вообще я это делаю{p}
желаю не здохнуть до двадцати{p}
хотя похуй вообще{p}
жопу соси{p}

короче всё, свободен, удачки  'ˬ'{p}

Данное дрисняво-слащавое произведение тулатеного искуства выложено по приколу вот {a=https://github.com/Boka11037?tab=repositories}тут{/a}

Сделано для всеми любимого Ярославчика от всеминелюбимого Богданчика
""")
...
define build.name = "Yaroslav_Novell"
...
define config.save_directory = "Yaroslav_Novell-1771333226"
...
define config.window_icon = "gui/Neco-Arc.png"
