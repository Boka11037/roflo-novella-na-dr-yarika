...
screen main_menu():
    on "show" action Play("music", "audio/baza.ogg" )

    ## Этот тег гарантирует, что любой другой экран с тем же тегом будет
    ## заменять этот.
    tag menu

    add Transform(gui.main_menu_background, fit="cover")
...
screen keyboard_help():
    ...
    hbox:
        label "alt + F4"
        text _("Делает вашу жизнь лучше.")
...
screen gamepad_help():
    ...
    textbutton _("") action GamepadCalibrate()
